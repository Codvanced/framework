...
namespace IOC.FW.Core.Database.Repository
{
        ...
        where TModel : class, new()
    {
        ...
        private EntityFrameworkContext<TModel> CreateContext()
        {
            if (this.connection != null
                && this.connection.State == ConnectionState.Open
            )
            {
                var newRepo = new EntityFrameworkContext<TModel>(this.connection, false);
                newRepo.Database.UseTransaction(this.transaction);
                return newRepo;
            }
            else
            {
                return new EntityFrameworkContext<TModel>(this.nameOrConnectionString);
            }
        }
        ...
        private DbConnection OpenConnection(EntityFrameworkContext<TModel> context)
        {
        ...
        private int Count(
            ...
            EntityFrameworkContext<TModel> context
        )
        {
            if (context == null)
            {
