...
namespace IOC.FW.Core.Implementation.Repository.ADO
{
        ...
        where TModel : class, new()
    {
        ...
        public Enumerators.RepositoryType Type
        {
            get 
            {
                return Enumerators.RepositoryType.ADO;
            }
        }
        ...
        public void UpdatePriority<TPriorityModel>(params TPriorityModel[] items) where TPriorityModel : TModel, Abstraction.Miscellaneous.IPrioritySortable
        {
            throw new NotImplementedException();
        }
